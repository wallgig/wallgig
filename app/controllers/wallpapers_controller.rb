class WallpapersController < ApplicationController
  ...
  before_action :authenticate_user!, except: [:index, :index_v2, :show, :set_profile_cover, :toggle_favourite, :collections, :toggle_collect]
  before_action :set_user, only: [:index, :index_v2]
  ...
  def index
    ...
    @initial_wallpapers_in_json = render_to_string(
      template: 'api/v1/wallpapers/index',
      formats: [:json],
      locals: {
